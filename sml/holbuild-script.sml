...
use_hol("tools/util/regexpMatch.sig");
use_hol("tools/util/regexpMatch.sml");
use_hol("tools/Holmake/hmf/parse_glob.sig");
use_hol("tools/Holmake/hmf/parse_glob.sml");
use_hol("tools/Holmake/core/Holmake_tools_dtype.sml");
use_hol("tools/Holmake/core/Holmake_tools.sig");
use_hol("tools/Holmake/core/Holmake_tools.sml");
use_hol("tools/Holmake/hmf/internal_functions.sig");
use_hol("tools/Holmake/hmf/internal_functions.sml");
use_hol("tools/Holmake/hmf/Holmake_types.sig");
use_hol("tools/Holmake/hmf/Holmake_types.sml");
use_hol("tools/Holmake/hmf/ReadHMF.sig");
use_hol("tools/Holmake/hmf/ReadHMF.sml");
