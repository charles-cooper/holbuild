...
val runtime_fragment_structure_lines =
  ["fun holbuild_flatten_frags frags = let",
   ...
   "fun holbuild_opaque_text body sp = holbuild_span_text body sp;",
   "fun holbuild_opaque_named body name sp = String.isPrefix name (holbuild_opaque_text body sp);",
   "fun holbuild_opaque_is_induction body sp = holbuild_opaque_named body \"Induct_on\" sp orelse holbuild_opaque_named body \"Induct\" sp;",
   "fun holbuild_opaque_is_case_split body sp = holbuild_opaque_named body \"Cases_on\" sp;",
   "fun holbuild_opaque_is_conj_tac body sp = holbuild_opaque_named body \"CONJ_TAC\" sp orelse holbuild_opaque_named body \"conj_tac\" sp;",
   "fun holbuild_expr_is_conj_tac body e = (case e of TacticParse.Opaque (_, sp) => holbuild_opaque_is_conj_tac body sp | TacticParse.Group (_, _, e) => holbuild_expr_is_conj_tac body e | _ => false);",
   "fun holbuild_expr_can_create_shared_subgoals body e = (case e of",
   "    TacticParse.Opaque (_, sp) => holbuild_opaque_is_induction body sp orelse holbuild_opaque_is_case_split body sp",
   "  | TacticParse.Repeat e => holbuild_expr_is_conj_tac body e",
   "  | TacticParse.Try e => holbuild_expr_is_conj_tac body e",
   "  | TacticParse.Group (_, _, e) => holbuild_expr_can_create_shared_subgoals body e",
   "  | TacticParse.RepairGroup (_, _, e, _) => holbuild_expr_can_create_shared_subgoals body e",
   "  | _ => false);",
   "fun holbuild_then_requires_atomic body [] = false",
   "  | holbuild_then_requires_atomic body [_] = false",
   "  | holbuild_then_requires_atomic body (e :: rest) = holbuild_expr_can_create_shared_subgoals body e orelse holbuild_expr_requires_atomic body e orelse holbuild_then_requires_atomic body rest",
   "and holbuild_expr_requires_atomic body e = (case e of",
   "    TacticParse.Then es => holbuild_then_requires_atomic body es",
   "  | TacticParse.Group (_, _, e) => holbuild_expr_requires_atomic body e",
   "  | TacticParse.RepairGroup (_, _, e, _) => holbuild_expr_requires_atomic body e",
   "  | _ => false);",
   "fun holbuild_body_requires_atomic body = holbuild_expr_requires_atomic body (holbuild_parse_tactic body) handle _ => false;",
   ...
   "  | _ => false);",
   "fun holbuild_exprs_contain_branch es = List.exists holbuild_expr_contains_branch es",
   "and holbuild_expr_contains_branch e = (case e of",
   "    TacticParse.Then es => holbuild_exprs_contain_branch es",
   ...
   "  | TacticParse.Group (_, _, e) => holbuild_expr_contains_branch e",
   "  | TacticParse.RepairGroup (_, _, e, _) => holbuild_expr_contains_branch e",
   "  | _ => false);",
   ...
   "fun holbuild_group_atom_expr body (TacticParse.FAtom (TacticParse.Group (_, _, e))) = if holbuild_expr_contains_branch e orelse holbuild_reverse_branch_expr body e then NONE else if holbuild_is_composable e then SOME e else NONE",
