...
- The selected HOL checkout is implicit (`--holdir`/`HOLBUILD_HOLDIR`/`HOLDIR`), with `src` and `examples` available as normal sources; do not declare `[dependencies.HOLDIR]`
