...
bin/holbuild: sml/holbuild-script.sml sml/hash.sml sml/project.sml sml/source_index.sml sml/dependencies.sml sml/build_plan.sml sml/toolchain.sml sml/status.sml sml/theory_checkpoints.sml sml/build_exec.sml sml/cache.sml sml/commands.sml
